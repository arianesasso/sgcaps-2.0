...
class CreateInsertsTest extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    */
    ...
    {
        //organizations
        $this->execute("INSERT INTO organizations VALUES (1,NULL,'Caps I','DRS XIII','Atenção Especializada', true,'2015-05-14 00:00:00','2015-05-14 00:00:00'),(2,NULL,'Caps II','DRS XIII','Atenção Especializada', true,'2015-05-14 00:00:00','2015-05-14 00:00:00')");
        //papéis
        ...
        //usuários
        $this->execute("INSERT INTO users VALUES (1, 1, NULL, 'admin'," . "'$2y$10\$SCrZo/RtBtXV2CZVqArVzOvmEkH7qAbLZHsZQmIfIW8fsBAS25BEy', true, '2015-06-13 20:49:28','2015-06-15 01:13:53', NULL)");
        //permissões
        $this->execute("INSERT INTO permissions VALUES (1,1,1,4,'2015-06-13 00:00:00','2050-06-30 00:00:00','2015-06-14 00:00:00','2015-06-14 16:56:43',1)");
        //pessoas vinculadas à uma organizaćão
        $this->execute("INSERT INTO organizations_people VALUES (1,1,1,'2015-06-14 00:00:00',NULL)");
        //ações
        $this->execute("INSERT INTO actions VALUES (1,'Cadastrar Qualquer Usuário', 'cadastrar_qualquer_usuario', 'Users', 'add', now(), now()), (2,'Listar Usuários', 'listar_todos_usuarios', 'Users', 'index', now(), now()), (3,'Visualizar Qualquer Permissão', 'visualizar_qualquer_permissao', 'Users', 'view', now(), now()), (4,'Editar Usuário', 'editar_usuario', 'Users', 'edit', now(), now()), (5,'Mudar Status do Usuário', 'mudar_status_usuario', 'Users', 'changeActivation', now(), now()), (6,'Cadastrar Paciente', 'cadastrar_paciente', 'Patients', 'add', now(), now()), (7,'Listar Pacientes', 'listar_pacientes', 'Patients', 'index', now(), now()), (8,'Visualizar Pacientes', 'visualizar_paciente', 'Patients', 'view', now(), now()),  (9,'Editar Paciente', 'editar_paciente', 'Patients', 'edit', now(), now()),  (10,'Cadastrar Ação', 'cadastrar_acao', 'Actions', 'add', now(), now()), (11,'Listar Ações', 'listar_acoes', 'Actions', 'index', now(), now()), (12,'Editar Ação', 'editar_acao', 'Actions', 'edit', now(), now()), (13,'Deletar Ação', 'deletar_acao', 'Actions', 'delete', now(), now()),  (14,'Cadastrar Papel', 'cadastrar_papel', 'Roles', 'add', now(), now()), (15,'Listar Papéis', 'listar_papeis', 'Roles', 'index', now(), now()), (16,'Editar Papel', 'editar_papel', 'Roles', 'edit', now(), now()), (17,'Deletar Papel', 'deletar_papel', 'Roles', 'delete', now(), now()),  (18,'Visualizar indicadores demográficos', 'visualizar_indicadores_demograficos', 'Indicators', 'demographic', now(), now()),  (19,'Cadastrar Organização', 'cadastrar_organizacao', 'Organizations', 'add', now(), now()), (20,'Listar Organizações', 'listar_organizacoes', 'Organizations', 'index', now(), now()), (21,'Visualizar Organização', 'visualizar_organizacao', 'Organizations', 'view', now(), now()), (22,'Editar Organização', 'editar_organizacao', 'Organizations', 'edit', now(), now()),   (23,'Cadastrar Profissional', 'cadastrar_profissional', 'Professionals', 'add', now(), now()), (24,'Listar Profissionais', 'listar_profissionais', 'Professionals', 'index', now(), now()), (25,'Visualizar Profissional', 'visualizar_profissional', 'Professionals', 'view', now(), now()), (26,'Editar Profissional', 'editar_profissional', 'Professionals', 'edit', now(), now()), (27,'Adicionar Qualquer Permissão', 'adicionar_qualquer_permissao', 'Permissions', 'add', now(), now()), (28,'Cancelar Permissão', 'cancelar_permissao', 'Permissions', 'cancel', now(), now()),  (29,'Visualizar Menu Pacientes', 'menu_pacientes', 'Menu', 'patients', now(), now()), (30,'Visualizar Menu Profissionais', 'menu_profissionais', 'Menu', 'professionals', now(), now()), (31,'Visualizar Menu Atividades', 'menu_atividades', 'Menu', 'activities', now(), now()), (32,'Visualizar Menu Organizações', 'menu_organizacoes', 'Menu', 'organizations', now(), now()), (33,'Visualizar Menu Usuário', 'menu_usuarios', 'Menu', 'users', now(), now()), (34,'Visualizar Menu Indicadores', 'menu_indicadores', 'Menu', 'indicators', now(), now()), (35,'Visualizar Menu Administração', 'menu_administracao', 'Menu', 'administration', now(), now()), (36,'Visualizar SubMenu Papéis', 'submenu_papeis', 'Menu', 'roles', now(), now()), (37,'Visualizar SubMenu Ações', 'submenu_acoes', 'Menu', 'actions', now(), now()), (38,'Listar Usuários Locais', 'listar_usuarios_locais', 'Users', 'index', now(), now()), (39,'Cadastrar Usuário Local', 'cadastrar_usuario_local', 'Users', 'add', now(), now()), (40,'Adicionar Permissão Local', 'adicionar_permissao_local', 'Permissions', 'add', now(), now()), (41,'Visualizar Permissões Locais', 'visualizar_permissoes_locais', 'Users', 'view', now(), now()), (42,'Editar Senha Usuário', 'editar_senha_usuario', 'Users', 'edit', now(), now())");
